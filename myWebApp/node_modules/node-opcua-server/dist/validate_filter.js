...
function isNumberDataType(node) {
    if (node.dataType.namespace === 0 && node.dataType.identifierType === node_opcua_nodeid_1.NodeIdType.NUMERIC && node.dataType.value < 22) {
        switch (node.dataType.identifierType === node_opcua_nodeid_1.NodeIdType.NUMERIC && node.dataType.value) {
